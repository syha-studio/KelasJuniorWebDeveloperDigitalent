...
if (isset($_POST["submit"])) {
    if (tambahkegiatan($_POST) > 0) {
        echo "
        <script>
          alert('Kegiatan Berhasil Diunggah!');
...
<head>
    ...
    <title>Tambah Kegiatan - BPSDMP KOMINFO Surabaya</title>
            ...
            <div class="row p-3">
                <div class="col-md-12">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="row g-3">
                        <input type="text" hidden name="created_date" value="<?= date("Y-m-d") ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-2">
                                <div class="mb-2">
                                    ...
                                    <input class="form-control" type="file" name="gambar" id="gambar" required autocomplete="off">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col mb-2">
                                ...
                                <textarea class="form-control" name="isi" id="isi" style="height: 25rem" required></textarea>
                            </div>
                        </div>
